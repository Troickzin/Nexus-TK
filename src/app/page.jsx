    ...
    <>
      <div className="w-screen h-screen overflow-hidden">
        <div className="grid ml-[75px] mt-[160px] w-fit">
          <p className="text-nexus-white-100 text-4xl">Bem-Vindo ao</p>
          <p className="text-nexus-white-50 text-8xl mt-[-10px] mb-[-10px]">
            <span className="text-nexus-primary-color">N</span>EXUS{" "}
            <span className="text-nexus-primary-color">T</span>K
          </p>
          <p className="text-nexus-white-100 text-xl">
