export default function Footer() {
    return (<>
      ...
      <div className="text-nexus-txt-50 bg-nexus-bg-300 w-screen relative">
        <div
          className="absolute right-0 max-lg:bottom-16 lg:top-0 max-lg:w-full lg:h-full grid justify-center content-center overflow-hidden z-0"
        >
          <svg
          ...
          >
            <path
              d="M244.413 7.88447C255.669 -1.81821 272.331 -1.81821 283.587 7.88446L516.639 208.777C530.523 220.745 530.523 242.255 516.639 254.223L283.587 455.116C272.331 464.818 255.669 464.818 244.413 455.116L11.3605 254.223C-2.52294 242.255 -2.52293 220.745 11.3606 208.777L244.413 7.88447Z"
            />
          </svg>
        ...
        <div className="flex z-10 text-[15px]">
          <div
            className="grid lg:flex justify-center content-center w-full mt-10 mb-10"
          >
              ...
              <ul className="list-disc ml-5 lg:ml-10 mt-5">
                ...
                <li>
                  <a href="https://x.com/nexus_tk_mc" target="_blank"
                    >X / Twitter: @nexus_tk_mc</a
                  >
                </li>
                <li>
                  <a href="https://www.youtube.com/@NEXUS_TK_MC" target="_blank"
                    >Youtube: NEXUS TK MC</a
                  >
                </li>
              </ul>
            </div>
            ...
            <div className="lg:ml-auto lg:mr-auto max-lg:mt-10 relative pl-2 pr-2">
              ...
              <ul className="list-disc ml-5 lg:ml-10 mt-5">
                ...
                <li>
                  <a href="https://mcreator.net/" target="_blank">MCreator</a>
                </li>
                <li>
                  <a
                ...
                <li>
                  <a
                    ...
                    target="_blank"
                    >Kleiders Custom Renderer API</a
                  >
                </li>
                <li>
                  <a
        ...
        <div className="grid lg:flex w-screen relative bg-nexus-bg-200 pt-2 pb-2">
          <div
            className="flex lg:absolute gap-x-4 lg:ml-10 max-lg:m-auto max-lg:mb-2"
          >
