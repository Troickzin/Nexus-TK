    ...
    <>
      ...
      >
        ...
        >
          ...
          <div
            className="group-data-[small=true]/navbar:w-0 group-data-[small=true]/navbar:text-nexus-dark-400 group-data-[small=true]/navbar:group-hover/button:w-auto overflow-hidden transition-all duration-75 group-data-[small=true]/navbar:duration-[0.3s]"
            style={{ interpolateSize: "allow-keywords" }}
          >
        ...
        <Link href="/">
          <icons.Nexus_TK
            ...
            color2="fill-nexus-white-400 group-hover/icon:fill-nexus-primary-color transition-all "
